...
public class TestBase extends AbstractTestNGCucumberTests{
	...
	public void startDriver(@Optional("chrome-headless-linux") String browserName)
	{
		...
		else if (browserName.equalsIgnoreCase("chrome-headless-mac"))
		{
			System.setProperty("webdriver.chrome.driver", "/Users/ignore/Documents/Selenium/67_Linux/Resources/chromedriver_mac");
