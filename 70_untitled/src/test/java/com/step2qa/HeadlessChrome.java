...
public class HeadlessChrome {
    ...
    public void open_headless_chrome() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//a//h3[contains(text(),'Step 2 CK | USMLE')]")).click();

        Thread.sleep(5000);

        System.out.println("Verify Step2QA homepage opens");
        Assert.assertEquals(driver.getTitle(), "Step 2 CK | USMLE", "Failed to open the clicked site.");
